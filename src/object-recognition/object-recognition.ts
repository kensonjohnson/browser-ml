    ...
    for (let n = 0; n < predictions.length; n++) {
      ...
      if (predictions[n].score > 0.66) {
        ...
        p.setAttribute(
          ...
          }px; width: ${predictions[n].bbox[2] - 10}px; top: 0; left: 0;`
        );
        ...
        highlighter.setAttribute(
          "style",
          `left: ${predictions[n].bbox[0]}px; top: ${predictions[n].bbox[1]}px; width: ${predictions[n].bbox[2]}px; height: ${predictions[n].bbox[3]}px;`
        );
